    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Cadastrar Torcedor</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-box">
					<form action="<?= base_url() ?>index.php/Torcedores/criarTorcedor" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>Nome<span class="text-danger">*</span></label>
                                <input type="text" name="nome" parsley-trigger="change" required placeholder="Nome" class="form-control">
                            </div>

                            <div class="form-group col-md-5">
                                <label>CPF<span class="text-danger">*</span></label>
                                <input id="documento" data-mask="000.000.000.00" type="text" name="documento" parsley-trigger="change" required placeholder="CPF" class="form-control">
                            </div>

                            <div class="form-group col-md-7">
                                <label>Email<span class="text-danger">*</span></label>
                                <input type="email" name="email" parsley-trigger="change" required placeholder="E-mail" class="form-control">
                            </div>

                            <div class="form-group col-md-6">
                                <label>Telefone<span class="text-danger">*</span></label>
                                <input data-mask="(00) 90000-0000" type="text" name="telefone" parsley-trigger="change" required placeholder="Telefone" class="form-control">
                            </div>
                            

                            <div class="form-group col-md-6">
                                <label>CEP<span class="text-danger">*</span></label>
                                <input data-mask="00000-000" type="text" name="cep" parsley-trigger="change" required placeholder="Cep" class="form-control">
                            </div>
