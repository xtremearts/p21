    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Cadastrar UF</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-box">
					<form action="<?= base_url() ?>index.php/CidadesEBairros/cadastrarUF" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>UF<span class="text-danger">*</span></label>
                                <input type="text" name="uf" parsley-trigger="change" required placeholder="Nome" class="form-control">
                            </div>
                        </div>
